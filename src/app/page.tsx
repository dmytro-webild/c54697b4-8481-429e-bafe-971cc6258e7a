...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/cosmic-background-with-dark-light-blue-laser-lights-perfect-digital-wallpaper_181624-23690.jpg",
          imageAlt: "Cosmic blue laser light digital background",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/3d-rendering-futuristic-sci-fi-techno-lights-background_181624-21133.jpg",
          imageAlt: "Futuristic sci-fi techno lights",
        },
        {
          ...
          imageAlt: "Futuristic neon geometric background",
        },
      ]}
      ...
      metrics={[
        {
          id: "m1",
          value: "10x",
          description: "Faster content generation",
        },
        {
          id: "m2",
          value: "99.9%",
      ...
      features={[
        {
          ...
          description: "Produce high-quality articles, posts, and copy in seconds.",
        },
        {
          icon: Image,
          title: "Visual Creation",
          description: "Generate engaging visuals and videos that drive engagement.",
        },
        {
          icon: Settings,
          title: "Smart Automation",
          description: "Automate repetitive tasks and focus on your big ideas.",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Alex Rivet",
          role: "Founder",
          testimonial: "NexAI completely changed my workflow. Speed is unparalleled.",
        ...
        },
        {
          ...
          name: "Sarah Chen",
          role: "Researcher",
          testimonial: "Finally, an AI tool that actually understands creative context.",
        ...
        },
        {
          ...
          name: "Mike Ross",
          role: "Dev",
          testimonial: "The automation tools save me hours every single week.",
        ...
        },
        {
          ...
          name: "Elena P.",
          role: "Designer",
          testimonial: "Visuals are stunning and generation is lightning fast.",
        ...
        },
        {
          ...
          name: "Julia V.",
          role: "Marketer",
          testimonial: "My content production has literally doubled in quality.",
      ...
      plans={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/cosmic-background-with-dark-light-blue-laser-lights_181624-21201.jpg",
      ...
      faqs={[
        {
          ...
          content: "We offer a generous free tier for new users.",
        },
        {
          id: "f2",
          title: "Can I automate workflows?",
          content: "Yes, our automation builder integrates seamlessly with thousands of apps.",
        },
        {
          id: "f3",
          title: "How is this different?",
          content: "We prioritize speed and creative output quality above all else.",
        },
      ]}
